            ...
            {success ? (
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center space-y-8 py-6">
               ...
               <div className="text-center space-y-6 py-4">
                  ...
                  <Link href="/forgot-password" title="New reset link" className="flex items-center justify-center gap-2 px-8 py-4 bg-white/5 border border-white/10 rounded-2xl text-xs font-black uppercase text-white hover:bg-white/10 transition-all">
