          ...
          <form onSubmit={handleLogin} className="relative z-10 space-y-8">
              ...
              <div className="space-y-2 group">
                <div className="flex justify-between items-center px-1">
                  ...
                  <Link 
                    ...
                    className="text-[11px] font-bold text-primary hover:text-white transition-colors flex items-center gap-1 group/link px-3 py-2 rounded-lg hover:bg-white/5"
                  >
            ...
            <div className="pt-2 space-y-4">
              <button
                ...
                className="w-full py-4 md:py-5 bg-gradient-to-r from-primary via-accent to-primary bg-[length:200%_auto] animate-gradient text-white rounded-2xl font-black text-[17px] shadow-xl shadow-primary/20 hover:shadow-primary/40 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-30 flex items-center justify-center gap-2 group/btn overflow-hidden relative mb-6"
              >
              ...
              <p className="text-center text-[13px] text-muted-foreground/60 font-medium pt-2">
                Not a member yet?{' '}
                <Link href="/signup" className="text-white font-black hover:underline underline-offset-4 decoration-primary transition-all p-2 inline-block">
                  Create Account
                </Link>
              </p>
            </div>
