              ...
              {step === 1 ? (
                ...
                >
                  <div className="text-center space-y-2 mb-6">
                    ...
                    <h1 className="text-2xl md:text-3xl font-black text-white tracking-tight">Your Profile</h1>
                ...
                >
                  <div className="text-center space-y-2 mb-6">
                    ...
                    <h1 className="text-2xl md:text-3xl font-black text-white tracking-tight">Security</h1>
          ...
          <div className="mt-8 text-center border-t border-white/5 pt-8">
            <p className="text-sm text-muted-foreground font-medium">
              Already have an account?{' '}
                <Link href="/login" className="text-white font-black hover:underline transition-all px-3 py-2 rounded-lg hover:bg-white/5 inline-block">
                  Log In
                </Link>
            </p>
          </div>
